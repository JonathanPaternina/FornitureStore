...
namespace FurnitureStore.API.Controllers
{
    ...
    public class OrdersController(FurnitureStoreContext context) : Controller
    {
        ...
        {
            if (order == null) return NotFound();
            if (order.OrderDetails == null) return BadRequest("Order shoul have at least one details");
